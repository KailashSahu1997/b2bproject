                ...
                <div class="col-12 col-lg-9 mt-4 mt-lg-0">
                    <div class="card">
                        ...
                        <div class="card-body card-body--padding--2">
                            <form action="<?=base_url('BuyerController/updated_business_detail')?>" method="POST" role="form" onsubmit="return onSubmit()">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control-select2" name="company_type">
                                                ...
                                                <option value="Stockist" <?php if($user_list->company_type=='Stockist'){ echo "selected"; }?>>Stockist</option>
                                                <option value="Wholesaler" <?php if($user_list->company_type=='Wholesaler'){ echo "selected"; }?>>Wholesaler</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-6">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="user_id" class="form-control" value="<?=$user_list->user_id?$user_list->user_id:$_SESSION['id']?>">
                                            <input type="text" name="company_name" class="form-control" placeholder="e.g John Due"  value="<?=$user_list->company_name?$user_list->company_name:$_SESSION['company_name']?>" readonly id="buyer-reg-company-name">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="city" class="form-control"  placeholder="e.g city" value="<?=$user_list->city?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="area_pincode" class="form-control"  placeholder="e.g Pincode" value="<?=$user_list->area_pincode?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            <label for="website">Website (Optional)</label> 
                                            <input type="text" name="website" class="form-control"  placeholder="e.g website (Optional)" value="<?=$user_list->website?>">
                                        </div>
                                    </div>
