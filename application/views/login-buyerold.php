            ...
            <div class="block-header__body">
                <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                    <ol class="breadcrumb__list">
                        ...
                        <li class="breadcrumb__item breadcrumb__item--current breadcrumb__item--last" aria-current="page"><span class="breadcrumb__item-link">Buyer Login</span></li>
                        <li class="breadcrumb__title-safe-area" role="presentation"></li>
                    </ol>
                </nav>
                <!-- <h1 class="block-header__title">Buyer Login</h1> -->
            </div>
        </div>
    </div>
        ...
        <div class="login-session">
            ...
            <form id="buyer-login" class="log-in">
                ...
                <div class="switch-btn">
                   <!--  <a href="javascript:void(0)" id="buyer-register-switch" class="discrete forgot" style="color: red;">SIGN UP</a> -->
                ...
                <!-- <p class="mt-4 mb-0 mw-100 text-center">Continue to this website, you accept to our <a href="<?=base_url()?>/buyer-terms-conditions" target="_blank">Terms of Conditions</a> and <a href="<?=base_url()?>/privacy-policy" target="_blank">Privacy Policy</a></p> -->
            ...
            <form id="buyer-forgot" class="log-in signup-area" method="post">
                <h4>Buyer Forgotten <span>Password</span></h4>
            ...
            <form id="buyer-otp-forgot" class="log-in signup-area" method="post">
                ...
                <div class="floating-label">
                    ...
                    <input class="form-input" placeholder="Enter OTP" type="hidden" name="mobile" id="buyer-otp-forgot-mobile">
            ...
            <div id="buyer-register" class="log-in signup-area style-reg">
                <form id="msform">
                    <h4>Register as <span>Buyer</span></h4>
                    ...
                    <fieldset id="business_details">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                <div class="floating-label">
                                    <select class="form-control-select2" name="buyer-reg-state" name="state" required="" id="buyer-reg-state">
                    ...
                    <fieldset id="bank_details">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-xs-12">
                                <div class="floating-label">
                                    <input class="form-input" placeholder="IFSC Code" type="text" name="Ifcs Code" id="ac_ifcs" required="">
                            ...
                            <div class="col-lg-12 col-md-12 col-12 switch-btn border-none">
                                <!-- <p class="mt-4 mb-0 mw-100 text-center">Continue to this website, you accept to our <a href="<?=base_url()?>/buyer-terms-conditions" target="_blank">Terms of Conditions</a> and <a href="<?=base_url()?>/privacy-policy" target="_blank">Privacy Policy</a></p> -->
                            </div>
...
<script>
    ...
    function business_detailsd()
    {
        ...
        let user_id=$('#buyer-reg-userid').val();
        //debugger;
        if(checkblank('buyer-reg-company-name','Company Name') && checkblank('buyer-reg-company-type','Type of Company') &&  checkblank('buyer-reg-office-address','Office address') && checkblank('buyer-reg-factory-address','Factory address') && checkblank('buyer-reg-city','City') && checkblank('buyer-reg-pincode','pincode') && checkblank('buyer-reg-state','State') && checkblank('buyer-reg-gst','GST Number') && checkblank('buyer-reg-pan','PAN Number'))
            $.ajax({
            type: 'post',
            url: '<?=base_url()?>/Welcome/post_array',
            dataType: "json",
