                ...
                <div class="col-12 col-lg-9 mt-4 mt-lg-0">
                    <div class="card">
                        ...
                        <div class="card-body card-body--padding--2">
                            <form action="<?=base_url('SellerController/update_personal_detail')?>" method="POST" role="form" onsubmit="return onSubmit()">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="full_name" class="form-control" id="full-name" placeholder="e.g John Due" required value="<?=$user_list->full_name?$user_list->full_name:$_SESSION['full_name']?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="landline_no" class="form-control" id="landline_no" placeholder="e.g 002 12345" value="<?=$user_list->landline_no?$user_list->landline_no:$_SESSION['landline_no']?>">
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="padding:10px">
                ...
                <button type="button" class="btn btn-danger" onclick="window.location.href='<?=base_url()?>seller/business-details'">OK</button>
                <?php }else{?>
                <button type="button" class="btn btn-danger" onclick="window.location.href='<?=base_url()?>seller/bank-details'">OK</button>
                <?php }?>
            </div>
        </div>
    </div>
</div>
<?php if(empty($companyname) || empty($acname)){?> 
<script>
