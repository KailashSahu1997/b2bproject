                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($order as $list){?>
                                            <tr>
                                                ...
                                                <th><button onclick="window.location.href='<?=base_url()?>buyer/compeleted-order-details/<?=$list->bidding_id?>'" type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="top" title="View"><i class="far fa-eye"></i></button></th>
                                            </tr>
                                            <!-- image show model -->
